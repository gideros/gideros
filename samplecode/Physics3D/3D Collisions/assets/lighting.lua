...
function Lighting.computeShadows(scene)
	...
	Lighting.shadowview:lookAt(Lighting.light[1],Lighting.light[2],Lighting.light[3],0,0,0,0,1,0)
	local lm=Lighting.shadowview:getTransform()
	p:multiply(lm)
	...
	Lighting.shadowrt:draw(Lighting.shadowview)
