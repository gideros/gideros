...
G_API size_t gaudio_WavRead(g_id id, size_t size, void *data, unsigned int *streamPos);
...
G_API size_t gaudio_Mp3Read(g_id id, size_t size, void *data, unsigned int *streamPos);
...
G_API size_t gaudio_XmpRead(g_id id, size_t size, void *data, unsigned int *streamPos);
