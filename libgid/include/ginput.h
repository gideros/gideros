...
enum
{
	...
	GINPUT_KEY_NUM8 = 418,
	GINPUT_KEY_NUM9 = 419,
	GINPUT_KEY_NUMDIV = 420,
	GINPUT_KEY_NUMMUL = 421,
	GINPUT_KEY_NUMSUB = 422,
	GINPUT_KEY_NUMADD = 423,
	GINPUT_KEY_NUMDOT = 424,
	GINPUT_KEY_NUMENTER = 425,
...
typedef struct ginput_KeyEvent
{
    int keyCode;
    int realCode;
    char charCode[1024]; //UTF-8 sequence generated by this keyChar event, NUL terminated
    int modifiers;
} ginput_KeyEvent;
