...
LIBS += -L"../libgid/external/libpng-1.6.2/build/gcc463_pi" -lpng
#LIBS += -L"../libgid/external/openal-soft-1.13/build/gcc463_pi" -lOpenAL32
LIBS += "../libgid/external/openal-soft-1.13/build/gcc463_pi/libopenal.so"

LIBS += -L"../libgid/external/glew-1.10.0/lib/gcc463_pi" -lGLEW
LIBS += -L"../libgid/external/jpeg-9/build/gcc463_pi" -ljpeg

LIBS += -L"../libgid/external/mpg123-1.15.3/lib/gcc463_pi" -lmpg123

LIBS += -lpthread

LIBS += -L"../libgid/external/zlib-1.2.8/build/gcc463_pi" -lzlibx
