...
#include "Include/vrapi/VrApi.h"
#include "Include/vrapi/VrApi_Helpers.h"
#include "Include/vrapi/VrApi_SystemUtils.h"
#include "Include/vrapi/VrApi_Input.h"
...
static ovrLayerProjection2 ovrRenderer_RenderFrame(
    ...
    for (int eye = 0; eye < renderer->NumBuffers; eye++) {
        ...
        oculus::doRender((eye==0)?1:0,vmat,pmat,frameBuffer->Width,frameBuffer->Height,roomEnabled,roomScreenEnabled,roomFloor);
