...
package com.giderosmobile.android.plugins.iab.frameworks.google;
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
		...
		if (mService != null) {
			if (mContext != null) {
				...
				logWarn("queryPurchaes **FAILED**. mContext is null.");
				verificationFailed = true;
			}
		}
		else {
			logWarn("queryPurchaes **FAILED**. mService is null.");
			verificationFailed = true;
		}
