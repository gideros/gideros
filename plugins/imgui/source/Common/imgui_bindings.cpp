...
{
    SpriteProxy* spriteProxy = static_cast<SpriteProxy*>(g_getInstance(L, "ImGui", index));
    return static_cast<GidImGui*>(spriteProxy->getContext());
}
...
int loader(lua_State* L)
{
    ...
    const luaL_Reg imguiStylesFunctionList[] =
    {
        ...
        {"setCircleSegmentMaxError", Style_SetCircleTessellationMaxError},
