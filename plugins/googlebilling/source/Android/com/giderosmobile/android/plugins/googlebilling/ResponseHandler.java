...
public class ResponseHandler {
     ...
     */
    public static void checkBillingSupportedResponse(ResponseCode responseCode, String type) {
        if (sPurchaseObserver != null) {
            sPurchaseObserver.onBillingSupported(responseCode, type);
        }
    }
    ...
    public static void purchaseResponse(
            ...
            final String orderId, final String notificationId, final long purchaseTime, final String developerPayload) {
        if (sPurchaseObserver != null) {
            sPurchaseObserver.onPurchaseStateChange(purchaseState, productId, notificationId, purchaseTime, developerPayload);
        }
    }
    ...
    public static void responseCodeReceived(Context context, ConfirmNotifications request,
            ResponseCode responseCode) {
        if (sPurchaseObserver != null) {
            sPurchaseObserver.onConfirmNotificationsResponse(request, responseCode);
        }
    }
}
