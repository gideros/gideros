...
static int BUTTONS_DEFAULT[12] = {BUTTON_A, BUTTON_B, BUTTON_X, BUTTON_Y, BUTTON_L1, BUTTON_R1, BUTTON_BACK, BUTTON_MENU, BUTTON_L3, BUTTON_R3, BUTTON_L2, BUTTON_R2};
// Line below was meant to fix XBOX/PS3 on Win, but recent tests shows it breaks most of controllers, even PS3
// Keeping it in comment for reference, and if some devices actually needed those, then add it again as an exception by checking VID/DID
