...
public abstract class PurchaseObserver {
     ...
     */
    public abstract void onBillingSupported(ResponseCode responseCode, String type);
    ...
    public abstract void onPurchaseStateChange(PurchaseState purchaseState,
            String itemId, String notificationId, long purchaseTime, String developerPayload);
    ...
    public abstract void onConfirmNotificationsResponse(ConfirmNotifications request,
            ResponseCode responseCode);
