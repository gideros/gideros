...
import com.giderosmobile.android.plugins.googlebilling.util.Base64;
import com.giderosmobile.android.plugins.googlebilling.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            PublicKey key = Security.generatePublicKey(mBase64EncodedPublicKey);
