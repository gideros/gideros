...
<a name='top'></a>
  ...
  <div class="container-fluid">
      ...
      <div class="span4 bs-docs-sidebar">
        ...
        <ul class="nav nav-list bs-docs-sidenav">
							...
							<ul class="dropdown-menu">
										...
										<li class='uplist dropdown closedlist'><a href="../StoreKit.html#StoreKit" id='StoreKit' class='closed item'><i class="icon-chevron-right"></i> <strong>StoreKit</strong></a>
							<ul class="dropdown-menu">
   ...
   <!-- last but not least the javascript -->
		...
		<script>window.jQuery || document.write('<script src="http://docs.giderosmobile.com/reference/plugin/js/js/jquery-1.8.3.min.js"><\/script>')</script>
