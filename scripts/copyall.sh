...
mkdir ~/Desktop/release/Gideros
mkdir ~/Desktop/release/Gideros/Gideros\ Studio
mv ~/Desktop/release/* ~/Desktop/release/Gideros/Gideros\ Studio
ln -s /Applications/ ~/Desktop/release/Gideros/Applications
