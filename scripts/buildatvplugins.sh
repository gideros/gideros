...
cd source
rm -rf build
/Applications/Xcode.app/Contents/Developer/usr/bin/xcodebuild -alltargets -sdk appletvos9.0 -configuration Release -project luasocket.xcodeproj GCC_PREPROCESSOR_DEFINITIONS='${inherited} TARGET_OS_TV=1' HEADER_SEARCH_PATHS='${inherited} ../../../lua/src' OTHER_CFLAGS="-fembed-bitcode"
