...
xcodebuild -alltargets -sdk iphoneos7.1 -configuration Release -project gvfs.xcodeproj
lipo build/Release-iphoneos/libgvfs.a build/Release-iphonesimulator/libgvfs.a -create -output libgvfs.a
cd ..

cd lua
xcodebuild -alltargets -sdk iphonesimulator7.1 -configuration Release -project lua.xcodeproj
xcodebuild -alltargets -sdk iphoneos7.1 -configuration Release -project lua.xcodeproj
lipo build/Release-iphoneos/liblua.a build/Release-iphonesimulator/liblua.a -create -output liblua.a
cd ..

cd ios/iosplayer
xcodebuild -alltargets -sdk iphonesimulator7.1 -configuration Release -project iosplayer.xcodeproj
xcodebuild -alltargets -sdk iphoneos7.1 -configuration Release -project iosplayer.xcodeproj
