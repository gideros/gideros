...
WINRT_PROJECT_FIXED=$(1)/$(2).vcxproj
...
winrt.openal:
	$(call WINRT_BUILD_FIXED,winrt/openal-soft,openal-soft)

winrt.openal.clean:
	$(call WINRT_CLEAN_FIXED,winrt/openal-soft,openal-soft)
...
winrt.libs: winrt.lua winrt.gvfs winrt.openal
...
winrt.core: winrt.libs winrt.shaders
	...
	mkdir -p winrt/x64/$(WINRT_CONF)/openal-soft
	cp winrt/openal-soft/x64/$(WINRT_CONF)/openal-soft/openal-soft.lib winrt/x64/$(WINRT_CONF)/openal-soft
...
winrt.template: winrt.core winrt.plugins 
	...
	cp winrt/openal-soft/x64/$(WINRT_CONF)/openal-soft/openal-soft.lib "$(RELEASE)/Templates/VisualStudio/WinRT Template/x64"
	#Plugins libs
