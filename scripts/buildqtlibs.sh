...
sudo rm /usr/lib/libgfile.1.dylib
...
cd libgfile
/Qt/1.2.1/Desktop/Qt/4.8.1/gcc/bin/qmake libgfile.pro
make clean
make
sudo cp libgfile.1.dylib /usr/lib
cd ..
