...
cd libgvfs
/Applications/Xcode.app/Contents/Developer/usr/bin/xcodebuild -alltargets -sdk appletvos9.0 -configuration Release -project gvfs.xcodeproj GCC_PREPROCESSOR_DEFINITIONS='${inherited} TARGET_OS_TV=1' OTHER_CFLAGS="-fembed-bitcode"
...
cd lua
/Applications/Xcode.app/Contents/Developer/usr/bin/xcodebuild -alltargets -sdk appletvos9.0 -configuration Release -project lua.xcodeproj GCC_PREPROCESSOR_DEFINITIONS='${inherited} TARGET_OS_TV=1' OTHER_CFLAGS="-fembed-bitcode"
...
cd ios/iosplayer
/Applications/Xcode.app/Contents/Developer/usr/bin/xcodebuild -alltargets -sdk appletvos9.0 -configuration Release -project iosplayer.xcodeproj GCC_PREPROCESSOR_DEFINITIONS='${inherited} TARGET_OS_TV=1' OTHER_CFLAGS="-fembed-bitcode"
