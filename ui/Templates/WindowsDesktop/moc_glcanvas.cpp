...
#include "../../../player/headers/glcanvas.h"
...
QT_MOC_LITERAL(1, 9, 18), // "projectNameChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "projectName"
QT_MOC_LITERAL(4, 41, 7) // "onTimer"

    },
    "GLCanvas\0projectNameChanged\0\0projectName\0"
    "onTimer"
};
...
void GLCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLCanvas::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLCanvas::projectNameChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GLCanvas::projectNameChanged(const QString & _t1)
{
