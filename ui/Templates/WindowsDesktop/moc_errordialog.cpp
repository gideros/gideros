...
#include "../../../player/headers/errordialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ErrorDialog_t, stringdata) + ofs \
...
void *ErrorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ErrorDialog.stringdata))
