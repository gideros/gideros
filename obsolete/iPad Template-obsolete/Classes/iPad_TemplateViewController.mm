...
@interface iPad_TemplateViewController ()
@property (nonatomic, retain) EAGLContext *context;
@property (nonatomic, assign) CADisplayLink *displayLink;
@end

@implementation iPad_TemplateViewController
...
- (void)awakeFromNib
{
	...
	gdr_initialize((EAGLView *)self.view, 768, 1024, false);
}
